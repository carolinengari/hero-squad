...
public class SquadTest {
    ...
    public void squad_instantiatesCorrectly_true() {
        Squad squad = new Squad("Zoey", "Save mummy", "12");
        assertTrue(squad instanceof Squad);
    }
    @Test
    public void squad_instantiatesWithName_String() {
        Squad squad = new Squad("Zoey", "Save mummy", "12");
        assertEquals("Zoey", squad.getName());
    }
    @Test
    public void squad_instantiatesWithCause_String() {
        Squad squad = new Squad("Zoey", "Save mummy", "12");
        assertEquals("Save mummy", squad.getCause());
    }
    @Test
    ...
    public void all_returnsAllInstancesOfSquad_true() {
        Squad squad = new Squad("Zoey", "Save mummy", "12");
        Squad squadTwo = new Squad("MamaBear", "Save baby", "13");
